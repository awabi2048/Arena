...
execute if score $MotionTimer Arena matches 30..90 positioned ~ ~-1.5 ~ run function arena:endless/boss/hidden/particle/spawning/01
execute if score $MotionTimer Arena matches 45..90 positioned ~ ~-1.5 ~ run function arena:endless/boss/hidden/particle/spawning/02
execute if score $MotionTimer Arena matches 60..90 positioned ~ ~-1.5 ~ run function arena:endless/boss/hidden/particle/spawning/03
