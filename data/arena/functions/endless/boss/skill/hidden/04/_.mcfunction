...
execute if score $Boss.SkillTimer Arena matches 100 if data storage arena:temp {Boss:{Skill:{04:{PillarCount:4}}}} run function arena:endless/boss/skill/hidden/04/debuff04
execute if score $Boss.SkillTimer Arena matches 100 if data storage arena:temp {Boss:{Skill:{04:{PillarCount:3}}}} run function arena:endless/boss/skill/hidden/04/debuff03
execute if score $Boss.SkillTimer Arena matches 100 if data storage arena:temp {Boss:{Skill:{04:{PillarCount:2}}}} run function arena:endless/boss/skill/hidden/04/debuff02
execute if score $Boss.SkillTimer Arena matches 100 if data storage arena:temp {Boss:{Skill:{04:{PillarCount:1}}}} run function arena:endless/boss/skill/hidden/04/debuff01
execute if score $Boss.SkillTimer Arena matches 100 if data storage arena:temp {Boss:{Skill:{04:{PillarCount:0}}}} run function arena:endless/boss/skill/hidden/04/bonus
