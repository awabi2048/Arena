...
# 最小ダメージ値設定
execute if data entity @e[tag=Arena.Core,sort=nearest,limit=1] {data:{Arena:{StageType:BetaExtra}}} run scoreboard players set $Boss.Temp.MinDamageAmount Arena 15
