# 中ボス召喚
summon vindicator ~ ~3 ~ {Tags:["Arena.Boss","Arena.MidBoss","Arena.Mob"],Attributes:[{Name:"generic.max_health",Base:1.0d},{Name:"generic.attack_damage",Base:1.0d},{Name:"generic.armor",Base:1.0d}],HandItems:[{id:"minecraft:golden_sword",Count:1b},{}],DeathLootTable:"arena:boss/mid_boss",CustomName:'{"text":"中ボス","color":"gold","bold": true}',ActiveEffects:[{Id:12,Amplifier:0b,Duration:1728000,ShowParticles:0b}],CustomNameVisible:1b}
