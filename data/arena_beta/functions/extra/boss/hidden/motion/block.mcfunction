...
execute if score $MotionTimer Arena matches 10 unless score $Temp.Health Arena matches ..500 if score $Random Arena matches ..33 run function arena_beta:extra/boss/hidden/skill/slash/_
execute if score $MotionTimer Arena matches 10 if score $Temp.Health Arena matches ..500 if score $Random Arena matches ..66 run function arena_beta:extra/boss/hidden/skill/slash/_

# 後始末
    execute if score $MotionTimer Arena matches 15.. run function arena_beta:extra/boss/hidden/motion/reset_pose
