...
execute if score $MotionTimer Arena matches 30..90 positioned ~ ~-1.4 ~ run function arena:endless/boss/hidden/particle/spawning/01
execute if score $MotionTimer Arena matches 45..90 positioned ~ ~-1.4 ~ run function arena:endless/boss/hidden/particle/spawning/02
execute if score $MotionTimer Arena matches 60..90 positioned ~ ~-1.4 ~ run function arena:endless/boss/hidden/particle/spawning/03
...
execute if score $MotionTimer Arena matches 100 positioned ~ ~-1.5 ~ run function arena:endless/boss/hidden/spawn

#execute if score $MotionTimer Arena matches 120 run function arena:endless/boss/hidden/skill/wave

execute if score $MotionTimer Arena matches 160.. run function arena:endless/boss/hidden/skill/wave

execute if score $MotionTimer Arena matches 160.. run function arena:endless/boss/hidden/motion/reset_pose
