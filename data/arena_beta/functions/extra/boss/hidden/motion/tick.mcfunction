...
execute if data storage arena: {Boss:{Motion:{Name:"Slash_3"}}} run function arena:endless/boss/hidden/motion/slash_3

execute if data storage arena: {Boss:{Motion:{Name:"Death"}}} run function arena:endless/boss/hidden/motion/death

execute if data storage arena: {Boss:{Motion:{Name:"Tp"}}} run function arena:endless/boss/hidden/motion/tp
