...
#
# 頭回転
execute if score $AnimationTimer ArenaBoss matches 1..20 as @e[tag=ArenaBoss.Part08,distance=..2] at @s run tp @s ~ ~ ~ ~18 ~
execute if score $AnimationTimer ArenaBoss matches 21..30 as @e[tag=ArenaBoss.Part08,distance=..2] at @s run tp @s ~ ~ ~ ~36 ~
execute if score $AnimationTimer ArenaBoss matches 31..40 as @e[tag=ArenaBoss.Part08,distance=..2] at @s run tp @s ~ ~ ~ ~18 ~

execute if score $AnimationTimer ArenaBoss matches 21..40 run tp @s ~ ~ ~ ~18 ~
...
# 発射
execute if score $AnimationTimer ArenaBoss matches 21..40 rotated ~9 ~ positioned ^ ^ ^1 run summon marker ~ ~0.6 ~ {Tags:["ArenaBoss.Skill02","ArenaBoss.SkillMarker"]}
execute if score $AnimationTimer ArenaBoss matches 21..40 rotated ~-9 ~ positioned ^ ^ ^1 run summon marker ~ ~0.6 ~ {Tags:["ArenaBoss.Skill02","ArenaBoss.SkillMarker"]}
