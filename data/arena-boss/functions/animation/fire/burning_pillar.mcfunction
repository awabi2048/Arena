...
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~4 ~-5 ~4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:orange_dye",Count:1b,tag:{CustomModelData:490101}}],Invisible:true,Marker:true,Fire:20000}
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~-4 ~-5 ~-4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:orange_dye",Count:1b,tag:{CustomModelData:490101}}],Invisible:true,Marker:true,Fire:20000}
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~4 ~-5 ~-4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:orange_dye",Count:1b,tag:{CustomModelData:490101}}],Invisible:true,Marker:true,Fire:20000}
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~-4 ~-5 ~4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:orange_dye",Count:1b,tag:{CustomModelData:490101}}],Invisible:true,Marker:true,Fire:20000}
...
execute if score $AnimationTimer ArenaBoss matches 200 run kill @e[tag=ArenaBoss.Skill03]
...
execute as @e[tag=ArenaBoss.Core] at @s run function arena-boss:animation/fire/particle/shield
