...
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~4 ~-5 ~4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:910190101}}],Invisible:true,Marker:true,Fire:20000}
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~-4 ~-5 ~-4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:910190101}}],Invisible:true,Marker:true,Fire:20000}
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~4 ~-5 ~-4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:910190101}}],Invisible:true,Marker:true,Fire:20000}
execute if score $AnimationTimer ArenaBoss matches 1 at @e[tag=ArenaBoss.Core] run summon armor_stand ~-4 ~-5 ~4 {Tags:["ArenaBoss.Skill03","ArenaBoss.SkillMarker"],ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:910190101}}],Invisible:true,Marker:true,Fire:20000}
